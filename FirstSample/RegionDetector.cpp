...
# endif
				...
				//Protocol::correctPara[CameraVar::cameraParam.worldX < 7000 ? PillarVar::index : PillarVar::index + 7].assign(Correct_Par);
				//PillarVar::correctedYaw[CameraVar::cameraParam.worldX < 7000 ? PillarVar::index : PillarVar::index + 7] += Correct_Par[3];
				...
				datafile << "飞盘" << regionVector[i].getSaucerIndex() << "是隔壁摩擦轮打的" << endl;
