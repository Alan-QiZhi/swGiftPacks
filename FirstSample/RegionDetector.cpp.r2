...
{
	//设置检测区的宽度
	int DETECTMINLIMIT = 2000;
	int DETECTMAXLIMIT = 3000;
...
# ifdef USESERIALPORT

				{
					...
					try
					{
						rc17::Protocol::sendDataBySerialPort((double)Correct_Par[1], (double)Correct_Par[2], (double)Correct_Par[3], (double)Correct_Par[5], (double)Correct_Par[4], CommunicationVariables::serialPort);
					}
					catch(...)
					{
						cout << "send failed";
